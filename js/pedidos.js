...
populateTable(tabelaPedidos);
  ...
  function atualizarTextoDropdown(dropdownId, buttonId) {
    const dropdownItems = document.querySelectorAll(`#${dropdownId} .dropdown-item`);
    const dropdownButton = document.getElementById(buttonId);
    const originalText = dropdownButton.getAttribute('data-original-text');
...
atualizarTextoDropdown('pagamentoFiltro', 'pagamentoButton');
atualizarTextoDropdown('entregadorFiltro', 'entregadorButton');
atualizarTextoDropdown('statusFiltro', 'statusButton');
